...
public class MyCSRServlet {
	...
	@Path("/gamertag")
	public String getGamertagInfo(@DefaultValue("Gl4di4torRr") @QueryParam("gamertag") String gamertag){
		...
		returnList = helper.combineLists(pp, pp.getPlayList(), pp.getRankList());
