...
public class ParseHelper {
	 ...
	 * @throws IOException
	 */
	public PlayerProfile getPlayerStats(String gamertag)
			throws IOException {
	 ...
	 * @return
	 */
	public ArrayList<String> combineLists(PlayerProfile pp,
		...
		for (int i = 0; i < pp.getPlayList().size() * 2; i++) {
			if (i % 2 == 0) {
				combinedList.add(pp.getPlayList().
						get(playlistCounter));
				playlistCounter++;
			} else {
				combinedList.add(pp.getRankList().
						get(rankCounter));
				rankCounter++;
			}
		}
